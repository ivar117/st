...
static char *font3[] = { "FontAwesome:size=15:antialias=true:autohint=true" };
static char *font4[] = { "Material Design Icons-Regular:size=16" };
...
/* bg opacity */
/*float alpha = 0.9, alphaUnfocused = 0.75;*/
float alpha = 1, alphaUnfocused = 0.8;

/* Terminal colors (16 first used in escape sequence) */
/*static const char *colorname[] = {*/

#include "colorschemes/nimda.h"
...
static char *followurl[] = { "/bin/sh", "-c", "st-urlhandler -o", "externalpipe", NULL };
static char *yankurl[] = { "/bin/sh", "-c", "st-urlhandler -c", "externalpipe", NULL };
static char *listurls[] = { "/bin/sh", "-c", "st-urlhandler -l", "externalpipe", NULL };
...
static Shortcut shortcuts[] = {
	...
	{ MODKEY,               XK_l,           externalpipe,   {.v = followurl} },
	{ MODKEY,               XK_c,           externalpipe,   {.v = yankurl} },
	{ MODKEY,               XK_t,           externalpipe,   {.v = listurls} },
